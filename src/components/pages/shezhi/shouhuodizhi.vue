      ...
      <div class="item flex-between" v-for="(item,index) in data" :key="index">
        <div class="left flex_1">
          <div id="column">
            ...
            <span class="default" :style="{background:item.is_default==1?'#FF4C23':'#cccccc'}" @click="default_(item.address_id)">默认</span>
          </div>
        ...
        <div class="right flex-between">
          ...
          <img src="@/assets/images/address_del.png" alt="" @click="del(item.address_id)">
        </div>
      </div>
    </div>
